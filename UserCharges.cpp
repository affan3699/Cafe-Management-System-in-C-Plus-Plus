...
UserCharges::UserCharges(){} //DEFAULT CONSTRUCTOR

UserCharges::~UserCharges(){} //DEFAULT DECONSTRUCTOR

std::istream& operator >>(std::istream &in, UserCharges& c1) //OVERLOADING EXTRACTION OPERATOR TO take new charges
{
...
void UserCharges::calculateCharges()  // FUNCTION TO CALCULATE CHARGES AND DISPLAY IN CHANGES RETURNED
{
	std::cout<<"UserCharges Called"<<std::endl;
	unsigned int netCharges = 0, change = 0, rs1000 = 0, rs500 = 0, rs100 = 0, rs50 = 0, rs10 = 0, rs05 = 0, rs02 = 0, rs01 = 0, totalNumberOfRupeeNotes = 0;

	netCharges = minutes * rate;
